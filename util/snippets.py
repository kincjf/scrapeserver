...
https://googleapis.dev/python/logging/2.6.0/handlers.html
https://googleapis.dev/python/logging/2.6.0/stdlib-usage.html
"""
...
# https://github.com/googleapis/python-logging/blob/main/samples/snippets/snippets.py
